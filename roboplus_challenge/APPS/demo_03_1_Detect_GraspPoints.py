...
if __name__=='__main__':
    ...
    print("====================")
    # rgb_data = cv2.imread("/mnt/workspace/roboplus_challenge/data/Grasp_RGB.png")
    rgb_data = cv2.imread("/home/hojin/catkin_ws/src/roboplus_challenge/data/Grasp_RGB.png")
    # depth_data = cv2.imread("/mnt/workspace/roboplus_challenge/data/Grasp_depth.png", -1)
    depth_data = cv2.imread("/home/hojin/catkin_ws/src/roboplus_challenge/data/Grasp_depth.png", -1)
    # ppx, ppy, fx, fy = np.load("intr_param.npy")
    ppx, ppy, fx, fy = np.load("/home/hojin/catkin_ws/src/roboplus_challenge/APPS/intr_param.npy")
    print("====================")
    filename="/home/hojin/catkin_ws/src/roboplus_challenge/data/Result_Data.json"
